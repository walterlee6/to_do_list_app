  ...
  Container imagess() {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 6, // Adjust itemCount to 6
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: index == 1 ? 7 : 0), // Adjust padding condition
              child: Container(
                ...
                child: Column(
                  children: [
                    Image.asset('assets/${index}.png'), // Load images from 1 to 6
                  ],
                ),
              ),
            ),
