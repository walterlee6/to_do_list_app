        ...
        children: [
          ...
          GestureDetector(
            onTap: (){
               Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SignUp_Screen(widget.show)),
              );
            },
            child: Text(
              'Sign UP',
  ...
  Widget Login_bottom() {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          AuthenticationRemote().login(email.text, password.text).then((success){
            Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => Home_Screen()), // Replace HomeScreen with your actual home screen widget
            );
          })
          .catchError((error){
